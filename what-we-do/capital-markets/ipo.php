...
<body>
                ...
                <div class="usp-row">
                            ...
                            <span class="icon">
                                <svg viewBox="0 0 38 37" width="32" height="32" fill="none"
                                    ...
                                    <defs>
                                        ...
                                        <linearGradient id="paint1_linear_145_13" x1="10.6194" y1="21.3553"
                                            x2="-0.525163" y2="23.2496" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#E24C4A"></stop>
                                            <stop offset="1" stop-color="#386BB7"></stop>
                                        </linearGradient>
                    ...
                    <div class="usp-data">
                        <div class="usp-data-header">
                            ...
                            <p>Showcase successful case studies or client testimonials that demonstrate the
                                effectiveness of
                                your services</p>
                        </div>
                        <div class="usp-icon">
    ...
    <div class="quote-container-main">

    </div>

    <div class="quote-section">
        <div class="quote-container">
            <div class="quote-container-content">
                ...
                <h3>I know the opportunities that come with multi—generational legacy planning. We're ready to work
                    alongside you.</h3>
                <p>My father founded Zuckerman Investment Group two decades and today I work to maintain his legacy and
                    support the next generation of clients we understand the challenges involved in multi-generational
                    legacy planning. our team works with you, your family and your advisors to create a cornprehensive
                    plan that works for everyone."</p>
                <h4>Daniel Zuckerman, Partner & CEO</h4>
            </div>
