<footer class="footer">
    <div class="footer-header">
        <div class="footer-newsletter">
            <h2>Get the latest news <br> on mail</h2>
            <div class="form">
                <input type="email" name="email" id="newsletter-email" placeholder="Enter your email here">
                <button>Submit <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
        ...
        <div class="footer-links">
            ...
            <div class="footer-link">
                ...
                <ul>
                    ...
                    <li><a href="">Corporate Restruturing</a></li>
    ...
    <div class="footer-footer">
        ...
        <div class="social-cta">
            ...
            <div class="linkedin">
                <a href="https://www.linkedin.com/company/gretex-corporate-services-limited/posts/?feedView=all"><svg
