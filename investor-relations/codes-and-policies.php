...
<head>
    ...
    <title>Codes & Policies - Gretex Corporate Services Limited</title>
        ...
        <div class="document-row">
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Anti-Sexual<br>Harassment Policy</h1>
                </div>
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Code For<br>Independent Directors</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Policy On<br>Preservation of Documents</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Policy On<br>Related Party Transaction</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Policy On Whistle Blower<br>& Vigil Mechanism</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Policy On<br>Determining Materiality</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Policy On Familiarisation<br>of Independent Directors</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Code of Conduct<br>of Merchant Banker</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Code Of Conduct For Intermediaries And Fiduciaries To Regulate, Monitor And Report Trading By
                        Designated Persons</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Nomination & Remuneration Policy<br>Dividend Distribution</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Policy Of<br>Dividend Distribution</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Code of Conduct For<br>Board Members & Senior Management</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
