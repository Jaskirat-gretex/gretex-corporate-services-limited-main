...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $baseUrl; ?>css/investor-relations/compliance-with-stock-exchange.css">
...
<body>
    ...
    <div class="main-hero">
        <div class="hero-header">
            <h1>Compliance With Stock Exchange</h1>
    ...
    <div class="general-container">
        <div class="accordion" id="accordion1">
            <div class="accordion-tabs">
                <div class="accordion-tab" data-accordion-target="tab1">2024 - 25</div>
            </div>
                            ...
                            <div class="document-row">
                                ...
                                <div class="document">
                                    <div class="icon-box">
                                        ...
                                        <h1>Large Entity Annual Disclosure <br>FY 2024-2025</h1>
                                    </div>
                                ...
                                <div class="document">
                                    <div class="icon-box">
                                        ...
                                        <h1>Large Entity Initial Disclosure <br> FY 2025-2026 </h1>
                                    </div>
                                    <div class="download-cta">
                                        <a class="view-button"
                                ...
                                <div class="document">
                                    <div class="icon-box">
                                        ...
                                        <h1>Reconciliation of <br>Share Capital</h1>
                                    </div>
                                    <div class="download-cta">
                                        <a class="view-button"
                                ...
                                <div class="document">
                                    <div class="icon-box">
                                        ...
                                        <h1>Regulation 24A of SEBI (LODR)<br>Regulations, 2015</h1>
                                    </div>
                                    <div class="download-cta">
                                        <a class="view-button"
                                ...
                                <div class="document">
                                    <div class="icon-box">
                                        ...
                                        <h1>Regulation 74(5) of the SEBI <br>(Depositories and Participants)
                                            Regulations, 2018</h1>
                                    </div>
                                    <div class="download-cta">
                                        <a class="view-button"
                            ...
                            <div class="document-row">
                                ...
                                <div class="document">
                                    <div class="icon-box">
                                        ...
                                        <h1>SDD Compliance certificate</h1>
                                    </div>
                                    <div class="download-cta">
                                        <a class="view-button"
                                ...
                                <div class="document">
                                    <div class="icon-box">
                                        ...
                                        <h1>Reconciliation of Share Capital</h1>
                                    </div>
                                    <div class="download-cta">
                                        <a class="view-button"
                            ...
                            <div class="document-row">
                                ...
                                <div class="document">
                                    <div class="icon-box">
                                        ...
                                        <h1>Investor Greivance13(3) June 24</h1>
                                    </div>
                                    <div class="download-cta">
                                        <a class="view-button"
