...
<head>
    ...
    <title>Financial Results - Gretex Corporate Services Limited</title>
        ...
        <div class="document-row">
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Financial Results for Half Year Ended on 30-09-2021</h1>
                </div>
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Financial Results for Half Year Ended on 31-03-2022</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Financial Results for Half Year Ended on 30-09-2022</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Financial Results for Half Year Ended on 31-03-2023</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Financial Results for Half Year Ended on 30-09-2023</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Financial Results for Three & Nine Months Ended on 31-12-2023</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Financial Results for Half Year Ended on 31-03-2024</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Financial Results for Half Year Ended on 30-09-2024</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
