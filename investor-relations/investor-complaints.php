...
<body>
    ...
    <div class="compliants-row">
        ...
        <div class="compliance-main" style="">
        ...
        <div class="compliance-main">
            <div class="compliance">
                <div class="compliance-header">
                    <h2>For any investor related queries, please contact at the below mentioned details</h2>
                </div>
                    ...
                    <div class="compliance-name">
                        <div class="compliance-icon-box">
                            ...
                            <div class="icon-content">
                                ...
                                <h3>Ms. Nishthi Dharmani</h3>
                            </div>
                        </div>
                    </div>
                    <div class="compliance-address">
                        <div class="compliance-icon-box">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="#000"
                            ...
                            <div class="icon-content">
                                <span>Address</span>
                                <h3>A- 401, Floor 4th, Plot FP-616, (PT), Naman Midtown, Senapati Bapat Marg, Near
                                    Indiabulls Dadar (W), S V S Marg, Mumbai- 400028, Maharashtra, India.</h3>
                            </div>
                        </div>
                    </div>
                    <div class="compliance-contact">
                        <div class="compliance-icon-box">
                            ...
                            <div class="icon-content">
                                ...
                                <h3>+91 90761 56000</h3>
                            </div>
                        </div>
                    </div>
                    <div class="compliance-mail">
                        <div class="compliance-icon-box">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="#000"
