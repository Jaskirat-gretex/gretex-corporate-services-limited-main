...
<body>
    ...
    <div class="general-container">
        <div class="investor-context-main">
            <div class="context-left">
                <h2>Boeing's mission is to protect, connect and explore our world and beyond. Every day, we are
                    dedicated to carrying out our mission - safely and sustainably. With revitalized spirit and an
                    unwavering commitment to transparency in all we do, we are transforming to be a better, stronger
                    Boeing, propelled by the spirit of innovation that has been our hallmark for more than a century.
                </h2>
            </div>
    ...
    <div class="general-container">
        <div class="key-figures">
            <div class="key-figure-head">
                <h2>Key Operating Figures For FY 2023-24</h2>
            </div>
            <div class="key-figures-row">
                <div class="key-figure">
                    <div class="key-figure-header">
                        <h2>$29.1B</h2>
                    </div>
                    <div class="key-figure-body">
                        <span>REVENUE</span>
                        <span>CC Growth: 3.4% YoY</span>
                    </div>
                </div>
                <div class="key-figure">
                    <div class="key-figure-header">
                ...
                <div class="swiper">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="environmental-slider">
                                <h2>Environment</h2>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero placeat, similique
                                    accusamus voluptate, eum dolorum quisquam ut architecto, veniam aperiam voluptates
                                    maxime itaque expedita.
                                </p>
                                <a href="">Read More</a>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="environmental-slider">
                                <h2>Social</h2>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero placeat,
                                    similique
                                    accusamus voluptate, eum dolorum quisquam ut architecto, veniam aperiam
                                    voluptates
                                    maxime itaque expedita.
                                </p>
                                <a href="">Read More</a>
