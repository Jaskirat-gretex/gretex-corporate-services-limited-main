        ...
        <ul class="navbar">
                        ...
                        <div class="mega-menu-row">
                            <div class="mega-menu-col">
                                ...
                                <a class="mega-menu-button"
                                    href="<?php echo $baseUrl; ?>what-we-do">Explore all
                                    services</a>
                            </div>
                            <div class="mega-menu-col">
                            ...
                            <div class="mega-menu-col">
                                ...
                                <div class="mega-menu-col-sub-container">
                                    <a class="mega-menu-nav-item" href="<?php echo $baseUrl; ?>what-we-do/corporate-finance/valuation">Valuation</a>
                                    <a class="mega-menu-nav-item" href="<?php echo $baseUrl; ?>what-we-do/corporate-finance/private-equity">Private Equity</a>
                                    <a class="mega-menu-nav-item" href="<?php echo $baseUrl; ?>what-we-do/corporate-finance/venture-capital">Venture Capital</a>
                                    <a class="mega-menu-nav-item" href="<?php echo $baseUrl; ?>what-we-do/corporate-finance/bank-finance-and-issue-of-debt-securities">Bank Finance and Issue of Debt Securities</a>
                                </div>
                            </div>
                            <div class="mega-menu-col">
                                <h3>Corporate Restructuring</h3>
                                <div class="mega-menu-col-sub-container">
                                    <a class="mega-menu-nav-item" href="<?php echo $baseUrl; ?>what-we-do/corporate-restructuring/mergers-and-acquisitions">Mergers & Acquisitions</a>
                                    <a class="mega-menu-nav-item" href="<?php echo $baseUrl; ?>what-we-do/corporate-restructuring/takeover">Takeover</a>
                                    <a class="mega-menu-nav-item" href="<?php echo $baseUrl; ?>what-we-do/corporate-restructuring/demergers">Demergers</a>
                                </div>
                            </div>
                            <div class="mega-menu-col">
            ...
            <ul class="nav-bar-dropdown">
                <li class="nav-item nav-dropdown">
                    <a class="nav-link" href="https://staging.gretexcorporate.com/investor-relations">Offer
                        Documents
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            <path fill="none" stroke="#fff" d="M4.5 6L8 9.5L11.5 6" stroke-width="1" />
                        </svg>
            ...
            <ul class="nav-bar-dropdown">
                <li class="nav-item nav-dropdown">
                    <a class="nav-link" href="https://staging.gretexcorporate.com/investor-relations">Investor
                        Relations
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            <path fill="none" stroke="#fff" d="M4.5 6L8 9.5L11.5 6" stroke-width="1" />
                        </svg>
                        ...
                        <li><a class="nav-link-white"
                            ...
                            <ul class="submenu">
                                ...
                                <li><a class="nav-link-white"
                                        ...
                                        Contact</a></li>
                                <li><a class="nav-link-white"
                                        href="https://staging.gretexcorporate.com/investor-relations/disclosures-under-reg-46-of-lodr/shareholding-pattern.php">
                                ...
                                <li><a class="nav-link-white"
                                        ...
                                        of Deviations</a></li>
                                <li><a class="nav-link-white"
                                        href="https://staging.gretexcorporate.com/investor-relations/disclosures-under-reg-46-of-lodr/compliance-with-stock-exchange.php">Compliance
                                        with Stock Exchange</a></li>
                                <li><a class="nav-link-white"
                                        href="https://staging.gretexcorporate.com/investor-relations/disclosures-under-reg-46-of-lodr/memorandum-of-association-and-articles-of-association.php">Memorandum
            ...
            <li class="nav-item">
                <a class="nav-link" href="https://staging.gretexcorporate.com/careers">Join Us</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="https://staging.gretexcorporate.com/about">Blog</a>
            </li>
