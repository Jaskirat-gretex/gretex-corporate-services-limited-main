...
<head>
    ...
    <title>Ms. Chambal Breweries And Distilleries Limited | Gretex Corporate Services Limited</title>
    <link rel="stylesheet"
        href="<?php echo $baseUrl; ?>css/offer-documents/open-offer-template-main/open-offer-template.css">
    <link rel="stylesheet" href="<?php echo $baseUrl; ?>css/offer-documents/open-offer/ms-chambal-breweries-and-distilleries-limited.css">
...
<body>
    ...
    <div class="main-hero">
        <div class="hero-header">
            <h1>Ms. Chambal Breweries And Distilleries Limited</h1>
        ...
        <div class="hero-footer">
            <div class="breadcrumbs">
                ...
                <span>Ms. Chambal Breweries And Distilleries Limited</span>
            </div>
        </div>
    </div>
        ...
        <div class="document-row">
            <div class="document">
                ...
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/offer-documents/open-offer/ms-chambal-breweries-and-distilleries-limited/Public-announcement.pdf"><span>Download</span>
