...
<head>
    ...
    <title>Sellowrap Industries Limited | Gretex Corporate Services Limited</title>
    <link rel="stylesheet" href="<?php echo $baseUrl; ?>css/Ipo/ipo-global.css">
    <link rel="stylesheet" href="<?php echo $baseUrl; ?>css/Ipo/sellowrap-industries-limited.css">
...
<body>
    ...
    <div class="main-hero">
        <div class="hero-header">
            <h1>Sellowrap Industries Limited</h1>
        ...
        <div class="document-row">
            <div class="document">
                ...
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/sellowrap-industries-limited/drhp-sellowrap.pdf"><span>Download</span>
