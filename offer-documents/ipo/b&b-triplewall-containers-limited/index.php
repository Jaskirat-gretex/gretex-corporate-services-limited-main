...
<head>
    ...
    <title>B&B Triplewall Containers Limited | Gretex Corporate Services Limited</title>
    <link rel="stylesheet" href="<?php echo $baseUrl; ?>css/Ipo/ipo-global.css">
    <link rel="stylesheet" href="<?php echo $baseUrl; ?>css/Ipo/b-&-b-triplewall-containers-limited.css">
...
<body>
    ...
    <div class="main-hero">
        <div class="hero-header">
            <h1>B&B Triplewall Containers Limited</h1>
            <p>B&B Triplewall Containers Limited, established in 2011 and headquartered in Bengaluru, specializes in
                manufacturing high-quality corrugated boxes and sheets. Serving the packaging industry, the company
                caters to various packaging companies and multinational corporations across India. Recognized for
                excellence, B&B Triplewall has earned prestigious accolades, including the Forbes Asia Best Under A
                Billion 2022 and Flipkart's Packaging Partner Award. Listed on the NSE SME in October 2018, the company
                continues to lead the market in sustainable packaging solutions.
            </p>
        </div>
        <div class="hero-footer">
            <div class="breadcrumbs">
                <a href="<?php echo $baseUrl; ?>">Home</a> / <a
                    href="<?php echo $baseUrl; ?>ipo">IPO</a> / <span>B&B Triplewall Containers
                    Limited</span>
            </div>
        </div>
    </div>
        ...
        <div class="document-row">
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Draft Prospectus <br>B&B Triplewall Containers Limited</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/b&b-triplewall-containers-limited/Draft-Prospectus_BB-Triplewall-Containers.pdf"><span>Download</span>
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Prospectus <br>B&B Triplewall Containers Limited</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/b&b-triplewall-containers-limited/PROSPECTUS-BB-triplewall-containers-limited.pdf"><span>Download</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M12 15.575q-.2 0-.375-.062T11.3 15.3l-3.6-3.6q-.3-.3-.288-.7t.288-.7q.3-.3.713-.312t.712.287L11 12.15V5q0-.425.288-.712T12 4t.713.288T13 5v7.15l1.875-1.875q.3-.3.713-.288t.712.313q.275.3.288.7t-.288.7l-3.6 3.6q-.15.15-.325.213t-.375.062M6 20q-.825 0-1.412-.587T4 18v-2q0-.425.288-.712T5 15t.713.288T6 16v2h12v-2q0-.425.288-.712T19 15t.713.288T20 16v2q0 .825-.587 1.413T18 20z" />
                        </svg></a>
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Basis of Allotment Advertisement<br>B&B Triplewall Containers Limited</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/b&b-triplewall-containers-limited/Advertisement_BOA.pdf"><span>Download</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M12 15.575q-.2 0-.375-.062T11.3 15.3l-3.6-3.6q-.3-.3-.288-.7t.288-.7q.3-.3.713-.312t.712.287L11 12.15V5q0-.425.288-.712T12 4t.713.288T13 5v7.15l1.875-1.875q.3-.3.713-.288t.712.313q.275.3.288.7t-.288.7l-3.6 3.6q-.15.15-.325.213t-.375.062M6 20q-.825 0-1.412-.587T4 18v-2q0-.425.288-.712T5 15t.713.288T6 16v2h12v-2q0-.425.288-.712T19 15t.713.288T20 16v2q0 .825-.587 1.413T18 20z" />
                        </svg></a>
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Abridged Prospectus<br>B&B Triplewall Containers Limited</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/b&b-triplewall-containers-limited/AbridgeProspectus.pdf"><span>Download</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M12 15.575q-.2 0-.375-.062T11.3 15.3l-3.6-3.6q-.3-.3-.288-.7t.288-.7q.3-.3.713-.312t.712.287L11 12.15V5q0-.425.288-.712T12 4t.713.288T13 5v7.15l1.875-1.875q.3-.3.713-.288t.712.313q.275.3.288.7t-.288.7l-3.6 3.6q-.15.15-.325.213t-.375.062M6 20q-.825 0-1.412-.587T4 18v-2q0-.425.288-.712T5 15t.713.288T6 16v2h12v-2q0-.425.288-.712T19 15t.713.288T20 16v2q0 .825-.587 1.413T18 20z" />
                        </svg></a>
