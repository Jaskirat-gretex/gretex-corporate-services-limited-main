...
<head>
    ...
    <title>IPO - Gretex Corporate Services Limited</title>
...
<body>
    ...
    <div class="listing-benefits">
        <div class="listing-benefits-header">
            <h2>Benefits of Listing</h2>
        </div>
        <div class="listing-benefits-row">
            <div class="listing-benefits-col">
                <div class="listing-benefits-imagebox">
                    <img src="../../assets/interest-free-capital-min.png" alt="">
                </div>
                <div class="listing-benefits-content">
                    <h2>Interest Free <br>Capital</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="listing">
        <div class="section-header">
            <h1 class="section-heading">Benefit of Listing</h1>
        </div>

        <div class="listing-row">
            <div class="listing-box">
                <img src="../../assets/Interest-free-capital.png" width="" alt="">
                <h1 class="listing-headline">Interest Free <br>Capital </h1>
            </div>

            <div class="listing-box">
                <img src="../../assets/Interest-free-capital.png" width="" alt="">
                <h1 class="listing-headline">Enhanced <br>Liquidity </h1>
            </div>
    ...
    <div class="general-container">
        <div class="criteria-main">
            <div class="criteria-header">
                <h2>Listing Criteria for Companies</h2>
            </div>
            <div class="criteria-content">
                <div class="criteria-box-1">
                    <div class="criteria-box-image">
                        <img src="" alt="">
                    </div>
                    <div class="criteria-box-content">
    ...
    <div class="general-container">
        <div class="section-header">
            <h1 class="section-heading">Listing Criteria for companies</h1>
        </div>

        <div class="criteria">

            <div class="criteria-box1">
                <div class="criteria-content">
                    <div class="criteria-heading">
                        <h3 class="listing-heading">Eligibility Criteria for BSE SME, NSE Emerge and Startup</h3>
                        <p class="listing-description">**Startup listing procedure is the same as SME Listing.
                            <br>*** Detailed updated criteria mentioned on SEBI website.
                        </p>
                    </div>
                    <div class="listing-button">
                        <a class="button" href=""><span>Know More</span> <i class="fa-solid fa-arrow-right"></i></a>

                    </div>
                </div>
                <div class="issue-image">
                    <img src="../../assets/bse-sme.png" alt="">
                </div>
            </div>
            ...
            <div class="criteria-box1">
                <div class="criteria-content">
                    <div class="criteria-heading">
                        <h3 class="listing-heading">Eligibility Criteria for Main Board Listing</h3>
                        <p class="listing-description">Detailed updated criteria available on BSE & NSE website
                        </p>
                    </div>
                    <div class="listing-button">
                        <a class="button" href=""><span>Know More</span> <i class="fa-solid fa-arrow-right"></i></a>
                ...
                <div class="issue-image">
                    <img src="../../assets/main-board-listing.png" alt="">
                </div>
            </div>
            ...
            <div class="criteria-box1">
                <div class="criteria-content">
                    <div class="criteria-heading">
                        <h3 class="listing-heading">Eligibility Criteria for as per ICDR 2018</h3>
                        <p class="listing-description">An issuer not satisfying the condition stipulated above shall be
                            eligible to make an initial public offer only if the issue is made through the book-building
                            process and the issuer undertakes to allot at least 75% of the net offer to QIB and to
                            refund the full subscription money if it fails to do so.
                        </p>
                    </div>
                    <div class="listing-button">
                        <a class="button" href=""><span>Know More</span><i class="fa-solid fa-arrow-right"></i></a>
                ...
                <div class="issue-image">
                    <img src="../../assets/SEBI-building.png" alt="">
                </div>
            </div>
        ...
        <div class="ipo-container">
            <div class="ipo-row">
                ...
                <div class="ipo-col">
                    <div class="ipo">
                        <div class="ipo-image">
                            <img src="../../assets/ipo/sagar-diamonds-limited.png" alt="">
                            <span>Listed on 7 Dec 2024</span>
                            <div class="ipo-cta-button">
                                <a
                ...
                <div class="ipo-col">
                    <div class="ipo">
                        <div class="ipo-image">
                            <img src="../../assets/ipo/billwin-industries-limited.png" alt="">
                            <span>Listed on 7 Dec 2024</span>
                            <div class="ipo-cta-button">
                                <a
                ...
                <div class="ipo-col">
                    <div class="ipo">
                        <div class="ipo-image">
                            <img src="../../assets/ipo/markolines-traffic-controls-limited.png" alt="">
                            <span>Listed on 7 Dec 2024</span>
                            <div class="ipo-cta-button">
                                <a
                ...
                <div class="ipo-col">
                    <div class="ipo">
                        <div class="ipo-image">
                            <img src="../../assets/ipo/owais-minerals-and-metals-processing.png" alt="">
                            <span>Listed on 7 Dec 2024</span>
                            <div class="ipo-cta-button">
                                <a
                ...
                <div class="ipo-col">
                    <div class="ipo">
                        <div class="ipo-image">
                            <img src="../../assets/ipo/rapid-multimodal-logistics-limited.png" alt="">
                            <span>Listed on 7 Dec 2024</span>
                            <div class="ipo-cta-button">
                                <a
                ...
                <div class="ipo-col">
                    <div class="ipo">
                        <div class="ipo-image">
                            <img src="../../assets/ipo/trackpoint-gps-limited.png" alt="">
                            <span>Listed on 7 Dec 2024</span>
                            <div class="ipo-cta-button">
                                <a
                ...
                <div class="ipo-col">
                    <div class="ipo">
                        ...
                        <div class="ipo-content">
                            <a href="">Arc Insulation & <br> Insulators Limited</a>
                ...
                <div class="ipo-col">
                    <div class="ipo">
                        ...
                        <div class="ipo-content">
                            <a href="">Taurian Mps <br> Limited</a>
