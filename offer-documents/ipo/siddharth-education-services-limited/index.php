...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/Gretex%20Corporate%20main/css/Ipo/siddharth-education-services-limited.css">
        ...
        <div class="hero-footer">
            <div class="breadcrumbs">
                <a href="http://localhost/Gretex%20Corporate%20main/">Home</a> / <a
                    href="http://localhost/Gretex%20Corporate%20main/ipo">IPO</a> / <span>Siddharth Education Services
                    Limited</span>
            </div>
        </div>
    </div>
        ...
        <div class="document-row">
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Draft Prospectus <br>Siddharth Education Services Limited</h1>
                </div>
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Red Herring Prospectus <br>Siddharth Education Services Limited</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Final Prospectus<br>Siddharth Education Services Limited</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Basis of Allotment Advertisement<br>Siddharth Education Services Limited</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Abridged Prospectus<br>Siddharth Education Services Limited</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
