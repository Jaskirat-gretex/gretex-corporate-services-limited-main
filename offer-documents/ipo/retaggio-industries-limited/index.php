...
<body>
    ...
    <div class="main-hero">
        <div class="hero-header">
            <h1>Retaggio Industries Limited</h1>
    ...
    <div class="document-container">
        <div class="document-row">
            ...
            <div class="document">
                ...
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/retaggio-industries-limited/retaggio-industries-ltd-corrigendum.pdf"><span>Download</span>
                        <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
            ...
            <div class="document">
                ...
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/retaggio-industries-limited/abridged-prospectus.pdf"><span>Download</span>
                        <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="document">
                ...
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/retaggio-industries-limited/prospectus.pdf"><span>Download</span>
                        <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="document">
                ...
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/retaggio-industries-limited/gid.pdf"><span>Download</span>
                        <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
