    ...
    <div class="main-hero">
        ...
        <div class="hero-footer">
            <div class="breadcrumbs">
                <a href="http://localhost/Gretex%20Corporate%20main">Home</a> / <a href="http://localhost/Gretex%20Corporate%20main/ipo">IPO</a> / <span>Akme Fintrade India Limited</span>
            </div>
        </div>
    </div>
        ...
        <div class="document-row">
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Draft Prospectus <br>Akme Fintrade India Limited</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
                        href="http://localhost/Gretex%20Corporate%20main/assets/documents/akme-fintrade-india-limited/DRHP_Akme-Fintrade.pdf"><span>Download</span>
