        ...
        <div class="document-row">
            <div class="document">
                ...
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/kids-medical-system-limited/kids-medical-draft-prospectus.pdf"><span>Download</span>
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Final Prospectus</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/kids-medical-system-limited/final-prospectus-kids-medical-system-limited.pdf"><span>Download</span>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12 18L4.5 10.5L6.6 8.325L10.5 12.225V0H13.5V12.225L17.4 8.325L19.5 10.5L12 18ZM3 24C2.175 24 1.469 23.7065 0.882 23.1195C0.295 22.5325 0.001 21.826 0 21V16.5H3V21H21V16.5H24V21C24 21.825 23.7065 22.5315 23.1195 23.1195C22.5325 23.7075 21.826 24.001 21 24H3Z"
                                fill="#141E47" />
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Addendum Cum Corrigendum</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/kids-medical-system-limited/corrigendum.pdf"><span>Download</span>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12 18L4.5 10.5L6.6 8.325L10.5 12.225V0H13.5V12.225L17.4 8.325L19.5 10.5L12 18ZM3 24C2.175 24 1.469 23.7065 0.882 23.1195C0.295 22.5325 0.001 21.826 0 21V16.5H3V21H21V16.5H24V21C24 21.825 23.7065 22.5315 23.1195 23.1195C22.5325 23.7075 21.826 24.001 21 24H3Z"
                                fill="#141E47" />
            ...
            <div class="document">
                ...
                <div class="download-cta">
                    <a class="view-button"
                        href="<?php echo $baseUrl; ?>assets/documents/kids-medical-system-limited/kids-medical-sysytems-limited_abridged-prospectus.pdf"><span>Download</span>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12 18L4.5 10.5L6.6 8.325L10.5 12.225V0H13.5V12.225L17.4 8.325L19.5 10.5L12 18ZM3 24C2.175 24 1.469 23.7065 0.882 23.1195C0.295 22.5325 0.001 21.826 0 21V16.5H3V21H21V16.5H24V21C24 21.825 23.7065 22.5315 23.1195 23.1195C22.5325 23.7075 21.826 24.001 21 24H3Z"
                                fill="#141E47" />
