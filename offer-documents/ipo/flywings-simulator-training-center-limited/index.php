...
<head>
    ...
    <title>Flywings Simulator Training Center Limited | Gretex Corporate Services Limited</title>
    <link rel="stylesheet" href="http://localhost/Gretex%20Corporate%20main/css/Ipo/ipo-global.css">
    <link rel="stylesheet" href="http://localhost/Gretex%20Corporate%20main/css/Ipo/flywings-simulator-training-center-limited.css">
...
<body>
    ...
    <div class="main-hero">
        <div class="hero-header">
            <h1>Flywings Simulator Training Center Limited</h1>
            <p>Veeram Ornaments Ltd (VOL) is an integrated Wholesaler, Trader & Retailer of
                branded Jewellery & Ornaments.</p>
        </div>
        <div class="hero-footer">
            <div class="breadcrumbs">
                <a href="http://localhost/Gretex%20Corporate%20main">Home</a> / <a
                    href="http://localhost/Gretex%20Corporate%20main/ipo">IPO</a> / <span>Flywings Simulator Training
                    Center Limited</span>
            </div>
        </div>
    </div>
        ...
        <div class="document-row">
            <div class="document">
                ...
                <div class="download-cta">
                    <a class="view-button"
                        href="http://localhost/Gretex%20Corporate%20main/assets/documents/flywings-simulator-training-center-limited/DRHP-Flywings.pdf"><span>Download</span>
