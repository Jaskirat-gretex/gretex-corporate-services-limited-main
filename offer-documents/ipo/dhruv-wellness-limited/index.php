...
<head>
    ...
    <title>Dhruv Wellness Limited | Gretex Corporate Services Limited</title>
    <link rel="stylesheet" href="http://localhost/Gretex%20Corporate%20main/css/Ipo/ipo-global.css">
    <link rel="stylesheet" href="http://localhost/Gretex%20Corporate%20main/css/Ipo/dhruv-wellness-limited.css">
        ...
        <div class="hero-footer">
            <div class="breadcrumbs">
                <a href="http://localhost/Gretex%20Corporate%20main">Home</a> / <a
                    href="http://localhost/Gretex%20Corporate%20main/ipo">IPO</a> / <span>Dhruv Wellness Limited</span>
            </div>
        </div>
    </div>
        ...
        <div class="document-row">
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Draft Prospectus <br>Dhruv Wellness Limited</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
                        href="http://localhost/Gretex%20Corporate%20main/assets/documents/dhruv-wellness-limited/Draft-Prospectus-Dhruv_Wellness_Ltd.pdf"><span>Download</span>
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Prospectus <br>Dhruv Wellness Limited</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
                        href="http://localhost/Gretex%20Corporate%20main/assets/documents/dhruv-wellness-limited/Prospectus-Dhruv-Wellness-Limited.pdf"><span>Download</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M12 15.575q-.2 0-.375-.062T11.3 15.3l-3.6-3.6q-.3-.3-.288-.7t.288-.7q.3-.3.713-.312t.712.287L11 12.15V5q0-.425.288-.712T12 4t.713.288T13 5v7.15l1.875-1.875q.3-.3.713-.288t.712.313q.275.3.288.7t-.288.7l-3.6 3.6q-.15.15-.325.213t-.375.062M6 20q-.825 0-1.412-.587T4 18v-2q0-.425.288-.712T5 15t.713.288T6 16v2h12v-2q0-.425.288-.712T19 15t.713.288T20 16v2q0 .825-.587 1.413T18 20z" />
                        </svg>
            ...
            <div class="document">
                <div class="icon-box">
                    ...
                    <h1>Basis Of Allotment<br>Dhruv Wellness Limited</h1>
                </div>
                <div class="download-cta">
                    <a class="view-button"
                        href="http://localhost/Gretex%20Corporate%20main/assets/documents/dhruv-wellness-limited/Basis-of-Allotment-Advertisement-2.pdf"><span>Download</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path fill="currentColor"
                                d="M12 15.575q-.2 0-.375-.062T11.3 15.3l-3.6-3.6q-.3-.3-.288-.7t.288-.7q.3-.3.713-.312t.712.287L11 12.15V5q0-.425.288-.712T12 4t.713.288T13 5v7.15l1.875-1.875q.3-.3.713-.288t.712.313q.275.3.288.7t-.288.7l-3.6 3.6q-.15.15-.325.213t-.375.062M6 20q-.825 0-1.412-.587T4 18v-2q0-.425.288-.712T5 15t.713.288T6 16v2h12v-2q0-.425.288-.712T19 15t.713.288T20 16v2q0 .825-.587 1.413T18 20z" />
                        </svg>
